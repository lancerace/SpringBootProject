...
+function(t) {
    ...
    i.prototype.show=function(e) {
        var s=this, n=t.Event("show.bs.modal", {
            relatedTarget: e
        }
        );
        ...
        this.backdrop(function() {
            ...
            n?s.$dialog.one("bsTransitionEnd",
            function() {
    ...
    i.prototype.backdrop=function(e) {
        ...
        if(this.isShown&&this.options.backdrop) {
            ...
            a).emulateTransitionEnd(i.BACKDROP_TRANSITION_DURATION):a()
        }
        else e&&e()
    }
    ,
    ...
    '[data-toggle="modal"]',
    function(i) {
        var s=t(this), n=s.attr("href"), o=t(s.attr("data-target")||n&&n.replace(/.*(?=#[^\s]+$)/, "")), a=o.data("bs.modal")?"toggle":t.extend( {
            remote: !/#/.test(n)&&n
        }
        ,
        o.data(),
...
+function(t) {
        ...
        if(!this.transitioning&&!this.$element.hasClass("in")) {
            ...
            if(!(n&&n.length&&(e=n.data("bs.collapse"), e&&e.transitioning))) {
                ...
                if(this.$element.trigger(o), !o.isDefaultPrevented()) {
                    ...
                    t.proxy(r,
                    this)).emulateTransitionEnd(s.TRANSITION_DURATION)[a](this.$element[0][l])
                }
            }
        }
    }
    ...
    s.prototype.hide=function() {
        if(!this.transitioning&&this.$element.hasClass("in")) {
            ...
            if(this.$element.trigger(e), !e.isDefaultPrevented()) {
                ...
                t.proxy(n,
                this)).emulateTransitionEnd(s.TRANSITION_DURATION):n.call(this)
            }
        }
    }
    ,
    ...
    ,
    s.prototype.addAriaAndCollapsedClass=function(t,
    e) {
        var i=t.hasClass("in");
